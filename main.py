...
主な使い方:
  ...
  python main.py creator-chat              # AI VTuber 会話 UI を起動
...
from creator_runtime.server import run_server as run_creator_server
...
def cmd_creator_chat():
    console.print(Panel("[bold magenta]🎙 Local AI Creator Chat[/bold magenta]"))
    console.print("  opening http://127.0.0.1:8767")
    run_creator_server(host="127.0.0.1", port=8767, persona_name="lab_vtuber")
